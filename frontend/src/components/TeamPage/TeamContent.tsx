...
const TeamContent = () => {
  ...
  return (
    <div className="mx-auto">
      ...
      <div className="bg-gray-50 border-gray-200 rounded-lg p-12 mb-8 mt-12">
        <h2 className="text-gray-900 text-5xl font-extrabold">
          {teamName}팀의 홈
        </h2>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <Link
          to={documentRoute}
          className="hover:bg-gray-100 bg-gray-50 border-gray-200 rounded-lg p-8 md:p-12"
        >
          <img src={documentImg} className="mb-2" />
          <h3 className="text-3xl font-bold tracking-tight">문서</h3>
        ...
        <Link
          ...
          className="hover:bg-gray-100 bg-gray-50 border-gray-200 rounded-lg p-8 md:p-12"
        >
          <img src={calendarImg} className="w-10 mb-2" />
          <h3 className="text-3xl font-bold tracking-tight">캘린더</h3>
          <p className="font-normal text-gray-700">
            팀 일정을 공유할 수 있는 캘린더
          </p>
        </Link>
